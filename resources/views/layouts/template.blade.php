    ...
    <body>
        ...
        <ul class="navbar-nav px-3">
            <div class="d-flex justify-content-center">
                    ...
                    <yt-icon class="style-scope ytd-topbar-menu-button-renderer"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" widht="24" height="24" style="pointer-events: none; display: block;"><g class="style-scope yt-icon">
                ...
                <path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z" class="style-scope yt-icon"></path>
                    ...
                    <li class="nav-item mr-3 text-nowrap">
                    <yt-icon class="style-scope ytd-notification-topbar-button-renderer"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" widht="24" height="24" style="pointer-events: none; display: block;"><g class="style-scope yt-icon">
